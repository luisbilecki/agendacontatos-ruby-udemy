class ContactsController < ApplicationController
  ...
  before_action :set_options_for_select, except: [:show]
  http_basic_authenticate_with name: "luis", password: "luis", only: :destroy
  ...
  def new
    ...
    #Dar um new para o endereço tbm
